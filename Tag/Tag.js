(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('prop-types'), require('classnames'), require('styled-components'), require('styled-system')) :
	typeof define === 'function' && define.amd ? define(['react', 'prop-types', 'classnames', 'styled-components', 'styled-system'], factory) :
	(global['Tag/Tag'] = factory(global.React,global.PropTypes,global.classNames,global.styled,global.styledSystem));
}(this, (function (React,PropTypes,classNames,styled,styledSystem) { 'use strict';

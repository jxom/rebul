(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('classnames'), require('react-autosize-textarea')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'classnames', 'react-autosize-textarea'], factory) :
	(factory((global['TextAreaField/index'] = {}),global.React,global.PropTypes,global.classNames,global.TextareaAutosize));
}(this, (function (exports,React,PropTypes,classNames,TextareaAutosize) { 'use strict';
